...
import { Pair, Bundle, Token, PactSwapFactory, PactSwapDayData, PairDayData, TokenDayData } from "../types/schema";
import { ONE_BI, ZERO_BD, ZERO_BI, FACTORY_ADDRESS } from "./helpers";

export function updatePactSwapDayData(event: EthereumEvent): PactSwapDayData {
    ...
    if (pactSwapDayData === null) {
        pactSwapDayData = new PactSwapDayData(dayID.toString());
        pactSwapDayData.date = dayStartTimestamp;
        pactSwapDayData.dailyVolumeUSD = ZERO_BD;
        pactSwapDayData.dailyVolumeETH = ZERO_BD;
        pactSwapDayData.totalVolumeUSD = ZERO_BD;
        pactSwapDayData.totalVolumeETH = ZERO_BD;
        pactSwapDayData.dailyVolumeUntracked = ZERO_BD;
    }

    pactSwapDayData.totalLiquidityUSD = pactSwap.totalLiquidityUSD;
    pactSwapDayData.totalLiquidityETH = pactSwap.totalLiquidityETH;
    pactSwapDayData.txCount = pactSwap.txCount;
